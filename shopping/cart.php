...
?>
    <div class="container">
        <div class="row d-flex justify-content-center align-items-center h-100 mt-5 mt-5">
          <div class="col-12">
            <div class="card card-registration card-registration-2 glass-card" style="border-radius: 15px;">
                ...
                <div class="row g-0">
                  <div class="col-lg-8">
                    <div class="p-5">
                      ...
                      <a href="<?php echo APPURL; ?>" class="btn btn-outline-light"><i class="fas fa-arrow-left"></i>  Continue Shopping</a>
                    </div>
                  </div>
