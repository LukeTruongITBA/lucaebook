            ...
            <div class="card-body">
              ...
              <form method="POST" action="create-products.php" enctype="multipart/form-data">
                ...
                <div class="form-outline mb-4 mt-4">
                  ...
                  <input type="text" name="name" id="form2Example1" class="form-control form-control-lg" placeholder="name" />
                </div>

                <div class="form-outline mb-4 mt-4">
                    <label>Price</label>

                    <input type="text" name="price" id="form2Example1" class="form-control form-control-lg" placeholder="price" />
                </div>

                <div class="form-group">
                    <label for="exampleFormControlTextarea1">Description</label>
                    <textarea name="description" placeholder="description" class="form-control form-control-lg" id="exampleFormControlTextarea1" rows="3"></textarea>
                </div>
                ...
                <div class="form-outline mb-4 mt-4">
                    ...
                    <input type="file" name="image" id="form2Example1" class="form-control form-control-lg" placeholder="image" />
                </div>

                <div class="form-outline mb-4 mt-4">
                    <label>File</label>
                    <input type="file" name="file" id="form2Example1" class="form-control form-control-lg" placeholder="file" />
                </div>
