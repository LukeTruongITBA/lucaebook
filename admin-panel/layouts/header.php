...
<head>
    ...
    <link href="http://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" rel="stylesheet">
     <link href="<?php echo ADMINURL; ?>/styles/theme-admin.css" rel="stylesheet">
...
<body>
<div id="wrapper">
    <nav class="navbar header-top fixed-top navbar-dark admin-navbar">
      <div class="container">
      <a class="navbar-brand admin-logo" href="<?php echo ADMINURL; ?>">
      ...
      <?php if(isset($_SESSION['adminname'])) : ?>
        ...
        <?php if(!isset($_SESSION['adminname'])) : ?>
          ...
          <?php else : ?>
            <li class="nav-item">
              <a class="nav-link text-dark" href="<?php echo ADMINURL; ?>">Home
                <span class="sr-only">(current)</span>
              </a>
            </li>
