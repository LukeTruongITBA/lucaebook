        ...
        <div class="col">
          ...
          <form method="POST" action="update-category.php?id=<?php echo $id; ?>" enctype="multipart/form-data">
                ...
                <div class="form-outline mb-4 mt-4">
                  <input type="text" name="name" value="<?php echo $categories->name; ?>" id="form2Example1" class="form-control form-control-lg" placeholder="name" />
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" placeholder="description" class="form-control form-control-lg" id="exampleFormControlTextarea1" rows="3">
